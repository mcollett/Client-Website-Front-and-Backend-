                ...
                <div class="block block-themed">
                    ...
                    <div class="block-content full">
                        <ul class="nav nav-tabs" data-toggle="tabs">
                            ...
                            <li><a href="#nah">NA - Horde</a></li>
                            <li><a href="#naa">NA - Alliance</a></li>
...
<?php $num_buyers = mysql_num_rows(mysql_query("SELECT id FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' ORDER BY id DESC")); ?>
 ...
 <h4 class="page-header">Total <small><?php echo $num_buyers; ?></small> | Revenue <small>$<?php echo number_format($earned, 2); ?> USD</small></h4>
                ...
                <div class="block-section">                 
                    <table id="example-datatables" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if ($num_buyers == 0) { echo "<tr><td colspan='10'>No buyers from this region and faction.</td></td>"; } ?>
                            <?php 
                                $get_past_buyers = mysql_query("SELECT * FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' ORDER BY id DESC");
                            ...
                            <tr>
                                ...
                                <td class="span1 text-center">
                                    <div class="btn-group">
                                        <a href="?page=edit_client&id=<?php echo $past_buyers['id']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-mini btn-success"><i class="icon-pencil"></i></a>
                                        <a onclick="return confirm('Are you sure you want to remove this user permanently?');" data-toggle="tooltip" title="Delete" class="btn btn-mini btn-danger" href="_actions/delete_client.php?id=<?php echo $past_buyers['id']; ?>"><i class="icon-remove"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
                ...
                <!-- END Dynamic Tables Section -->
                            ...
                            <div class="tab-pane" id="nah">

                                 <!-- Dynamic Tables Section -->
<?php $region = "US"; $faction = "Horde"; ?>
<?php $num_buyers = mysql_num_rows(mysql_query("SELECT id FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='$region' AND faction='$faction' ORDER BY id DESC")); ?>
<?php $get_total_earned = mysql_query("SELECT SUM(payment_amount) FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='$region' AND faction='$faction'"); 
while ($get_earned = mysql_fetch_array($get_total_earned)) {
    $earned = $get_earned['SUM(payment_amount)'];
}
?>
 ...
 <h4 class="page-header">Total <small><?php echo $num_buyers; ?></small> | Revenue <small>$<?php echo number_format($earned, 2); ?> USD</small></h4>
                ...
                <div class="block-section">                 
                    <table id="example-datatables" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if ($num_buyers == 0) { echo "<tr><td colspan='10'>No buyers from this region and faction.</td></td>"; } ?>
                            <?php 
                                $get_past_buyers = mysql_query("SELECT * FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='US' AND faction='Horde' ORDER BY id DESC");
                                while ($past_buyers = mysql_fetch_array($get_past_buyers)) {
                            ?>
                            <tr>
                                <td><?php echo $past_buyers['id']; ?></td>
                ...
                <!-- END Dynamic Tables Section -->
                            ...
                            <div class="tab-pane" id="naa">

                                 <!-- Dynamic Tables Section -->
<?php $region = "US"; $faction = "Alliance"; ?>
<?php $num_buyers = mysql_num_rows(mysql_query("SELECT id FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='$region' AND faction='$faction' ORDER BY id DESC")); ?>
<?php $get_total_earned = mysql_query("SELECT SUM(payment_amount) FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='$region' AND faction='$faction'"); 
while ($get_earned = mysql_fetch_array($get_total_earned)) {
    $earned = $get_earned['SUM(payment_amount)'];
                ...
                <div class="block-section">                 
                    <table id="example-datatables" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if ($num_buyers == 0) { echo "<tr><td colspan='10'>No buyers from this region and faction.</td></td>"; } ?>
                            <?php 
                                $get_past_buyers = mysql_query("SELECT * FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='US' AND faction='Alliance' ORDER BY id DESC");
                                while ($past_buyers = mysql_fetch_array($get_past_buyers)) {
                            ?>
                            <tr>
                                <td><?php echo $past_buyers['id']; ?></td>
 ...
 <h4 class="page-header">Total <small><?php echo $num_buyers; ?></small> | Revenue <small>$<?php echo number_format($earned, 2); ?> USD</small></h4>
                ...
                <div class="block-section">                 
                    <table id="example-datatables" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if ($num_buyers == 0) { echo "<tr><td colspan='10'>No buyers from this region and faction.</td></td>"; } ?>
                            <?php 
                                $get_past_buyers = mysql_query("SELECT * FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='EU' AND faction='Horde' ORDER BY id DESC");
                                while ($past_buyers = mysql_fetch_array($get_past_buyers)) {
                            ?>
                            <tr>
                                <td><?php echo $past_buyers['id']; ?></td>
                ...
                <!-- END Dynamic Tables Section -->
                            ...
                            <div class="tab-pane" id="eua">
                                 ...
                                 <!-- Dynamic Tables Section -->
<?php $region = "EU"; $faction = "Alliance"; ?>
<?php $num_buyers = mysql_num_rows(mysql_query("SELECT id FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='$region' AND faction='$faction' ORDER BY id DESC")); ?>
<?php $get_total_earned = mysql_query("SELECT SUM(payment_amount) FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='$region' AND faction='$faction'"); 
while ($get_earned = mysql_fetch_array($get_total_earned)) {
    $earned = $get_earned['SUM(payment_amount)'];
                ...
                <div class="block-section">                 
                    <table id="example-datatables" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if ($num_buyers == 0) { echo "<tr><td colspan='10'>No buyers from this region and faction.</td></td>"; } ?>
                            <?php 
                                $get_past_buyers = mysql_query("SELECT * FROM buyerlist WHERE run_status='incomplete' AND payment_status='paid' AND payment_method='USD' AND geography='EU' AND faction='Alliance' ORDER BY id DESC");
                                while ($past_buyers = mysql_fetch_array($get_past_buyers)) {
                            ?>
                            <tr>
                                <td><?php echo $past_buyers['id']; ?></td>
